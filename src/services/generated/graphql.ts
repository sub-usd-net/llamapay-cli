...
export const StreamByIdDocument = gql`
...
const GetAllTokensDocumentString = print(GetAllTokensDocument);
const StreamAndHistoryDocumentString = print(StreamAndHistoryDocument);
const StreamByIdDocumentString = print(StreamByIdDocument);
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    GetAllTokens(variables: GetAllTokensQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data: GetAllTokensQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<GetAllTokensQuery>(GetAllTokensDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'GetAllTokens', 'query');
    },
    StreamAndHistory(variables: StreamAndHistoryQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data: StreamAndHistoryQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<StreamAndHistoryQuery>(StreamAndHistoryDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'StreamAndHistory', 'query');
    },
    StreamById(variables: StreamByIdQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<{ data: StreamByIdQuery; extensions?: any; headers: Dom.Headers; status: number; }> {
        return withWrapper((wrappedRequestHeaders) => client.rawRequest<StreamByIdQuery>(StreamByIdDocumentString, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'StreamById', 'query');
    }
  };
}
